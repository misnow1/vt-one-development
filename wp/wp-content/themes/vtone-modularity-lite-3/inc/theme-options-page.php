...
<button type="button" class="button" name="wpml_image_select_button" class="upload_image_button">Add New Image</button>
<br/>
<br/>
<input type="submit" class="button" name="vtone-ml-theme-opts-submit" id="vtone-ml-theme-opts-submit" class="button" value="Save All" />
</form>
